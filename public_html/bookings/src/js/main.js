//@prepos-prepend "_jquery.js"
//@prepos-prepend "_semantic.js"

//@prepos-append "_checkboxes.js"
//@prepos-append "_reports.js" 
//@prepos-append "_waitingList.js" 
...
############################
*/
function initClassesReportForm() {
  var monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
  if ($('#startdate').val()) {
    $existingDate = convertToParsableDateString($('#startdate').val());
    $friendlyDate = $existingDate.getDate() + ' ' + monthNames[$existingDate.getMonth()] + ' ' + $existingDate.getFullYear();
  } else {
    $friendlyDate = '';
  }
  if ($('#enddate').val()) {
    $existingDate = convertToParsableDateString($('#enddate').val());
    $friendlyDate = $existingDate.getDate() + ' ' + monthNames[$existingDate.getMonth()] + ' ' + $existingDate.getFullYear();
  } else {
    $friendlyDate = '';
  }
...
// INITS THE EMAIL MODAL ON THE WAITING LIST SCREEN
initWaitingListEmailButton();

loadSalesReportsFromTable();
loadSalesReportsFromForm();
