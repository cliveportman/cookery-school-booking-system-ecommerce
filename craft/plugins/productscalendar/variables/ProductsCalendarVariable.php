...
class ProductsCalendarVariable
{
    ...
    public function getProducts($options = array())
    {
        ...
        if ($options['calendarLength'] == 'day') {
            ...
            */
            $calendarProducts = craft()->productsCalendar->getProductsSingleDay($calendarDays->days, $options['showDisabledProducts'] = '');
            ...
            */
            $calendarProducts = craft()->productsCalendar->getProductsMultiDay($calendarDays, $options['showDisabledProducts'] = '');
        }
